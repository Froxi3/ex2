...
$MESS['T_IBLOCK_DESC_NEWS_USE_SPECIAL_DATE'] = 'Установить свойство страницы specialdate';
$MESS['T_IBLOCK_ID_CANONICAL'] = 'ID информационного блока для rel=canonical';
$MESS['T_IBLOCK_AJAX_REPORT_NEWS'] = 'Собирать жалобы в режиме AJAX';
